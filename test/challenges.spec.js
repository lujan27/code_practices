...
describe("Missing Number", () => {
    it("Array #1", () => {
        (0, chai_1.expect)((0, practices_1.missingNo)(arr1)).to.equal(26);
    });
    it("Array #2", () => {
        (0, chai_1.expect)((0, practices_1.missingNo)(arr2)).to.equal(40);
    });
    it("Array #3", () => {
        (0, chai_1.expect)((0, practices_1.missingNo)(arr3)).to.equal(80);
    });
    it("Array #4", () => {
        (0, chai_1.expect)((0, practices_1.missingNo)(arr4)).to.equal(100);
    });
});
/* Max and Min value */
...
describe("Alphabet position", () => {
    it("Should return an string with the positions", () => {
        (0, chai_1.expect)((0, practices_1.alphabetPosition)("The sunset sets at twelve o' clock.")).to.equal("20 8 5 19 21 14 19 5 20 19 5 20 19 1 20 20 23 5 12 22 5 15 3 12 15 3 11");
